...
export CORE_PEER_TLS_ROOTCERT_FILE=/opt/gopath/src/github.com/hyperledger/fabric/peercdca.crt
...
peer channel update -o $ORDERER_ADDRESS -c $CHANNEL_ID -f bafsorgmspanchors.tx --tls --cafile $ORDERER_CA

...
function installAndinstantiate(){
    ...
    echo
    # sleep 5
    # peer chaincode instantiate -o $ORDERER_ADDRESS --tls true --cafile $ORDERER_CA -C $CHANNEL_TRADE -n invoice -l java -v j.1.2 -c '{"Args":["init"]}' -P "AND ('bafsorgmsp.member','exciseorgmsp.member')"
